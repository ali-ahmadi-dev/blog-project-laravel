                ...
                <div class="nav flex-nowrap align-items-center">
                    ...
                    <div class="nav-item dropdown position-relative">
                        ...
                        <a class="nav-link dropdown-toggle notif-dropdown-toggle p-2" href="#" id="pagesMenu"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-bell"
                                    ...
                                    <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                        <div class="w-100 mt-auto">
                                            ...
                                            <h4 class="text-white"><a href="post-single-4.html"
                                                    class="btn-link stretched-link text-reset">بهترین تابلوهای Pinterest
                                                    برای
                        ...
                        <div class="tiny-slider arrow-hover arrow-blur arrow-dark arrow-round">
                            <div class="tiny-slider-inner" style="float: left;" data-autoplay="true"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0 pt-3">
                                        <h5 class="card-title"><a href="post-single-3.html"
                                                class="btn-link text-reset">بهترین تابلوهای پینترست برای یادگیری در مورد
                                                تجارت</a></h5>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item">
                            ...
                            <div class="card bg-lights p-4" style="box-shadow: 0px 5px 20px 0px rgba(69, 67, 96, 0.1);">
                                ...
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <p class="card-text">ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                                        ...
                                        دستاوردهای
                                        اصلی
                                        و جوابگوی سوالات پیوسته اهل دنیای طراحی اساسا مورد.و جوابگوی سوالات پیوسته اهل
                                        دنیای طراحی اساسا
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" rows="10" cols="10"
                                        style="min-height: 300px;">من راهی برای دریافت پول برای سرگرمی مورد علاقه‌ام پیدا کرده‌ام و این کار را در حالی انجام می‌دهم که رویای سفر به دور دنیا را دنبال می‌کنم.</textarea>
                        ...
                        <div class="card border mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-check form-switch form-check-md mb-3">
                                    ...
                                    <label class="form-check-label" for="availabilityCheck">نمایش اطلاعات
                                        پروفایل</label>
                                </div>
                            </div>
                        </div>
